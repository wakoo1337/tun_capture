...
bin/tcpReadCallback.o: src/tcpReadCallback.c src/tcpReadCallback.h src/SrcDstSockaddrs.h src/IPPacketPayload.h src/TCPHeaderData.h src/TCPConnection.h src/TCPState.h src/emergencyStop.h
...
bin/tcpEstablishedReadCallback.o: src/tcpEstablishedReadCallback.c src/tcpEstablishedReadCallback.h src/contrib/heap.h src/CaptureContext.h src/SrcDstSockaddrs.h src/TCPSiteQueueItem.h src/TCPConnection.h src/PacketQueueItem.h src/dequeueSiteQueueItem.h src/tcpUpdateEvent.h src/processTCPUrgentData.h src/processTCPData.h src/enqueueRxPacket.h src/HEADERS_RESERVE.h src/MAX_APP_QUEUE.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/tcpEstablishedReadCallback.o src/tcpEstablishedReadCallback.c
bin/tcpEstablishedWriteCallback.o: src/tcpEstablishedWriteCallback.c src/tcpEstablishedWriteCallback.h src/contrib/heap.h src/CaptureContext.h src/SrcDstSockaddrs.h src/TCPSiteQueueItem.h src/TCPConnection.h src/dequeueSiteQueueItem.h
...
bin/tunWriteCallback.o: src/tunWriteCallback.c src/tunWriteCallback.h src/contrib/heap.h src/CaptureSettings.h src/CaptureContext.h src/dequeueTxPacket.h
...
bin/udpWriteCallback.o: src/udpWriteCallback.c src/udpWriteCallback.h src/UDPBinding.h src/UDPStackItem.h src/emergencyStop.h
...
bin/tcpWriteCallback.o: src/tcpWriteCallback.c src/tcpWriteCallback.h src/SrcDstSockaddrs.h src/IPPacketPayload.h src/TCPHeaderData.h src/TCPConnection.h src/TCPState.h src/emergencyStop.h
