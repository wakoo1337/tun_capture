...
bin/tunCallback.o: src/tunCallback.c src/tunCallback.h src/contrib/heap.h src/ForwardingMappingIPv4.h src/ForwardingMappingIPv6.h src/CaptureSettings.h src/CaptureContext.h src/PacketQueueItem.h src/packetsProcessor.h src/enqueuePacket.h
...
bin/processTCPPacket.o: src/processTCPPacket.c src/processTCPPacket.h src/contrib/avl.h src/contrib/heap.h src/CaptureContext.h src/IPPacketPayload.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/SrcDstSockaddrs.h src/TCPHeaderData.h src/TCPConnection.h src/TCPState.h src/parseTCPHeader.h src/tcpCallback.h src/compareTCPSitePrequeueItems.h src/tcpstate_connwait.h
...
bin/tcpstate_connwait.o: src/tcpstate_connwait.c src/tcpstate_connwait.h src/SrcDstSockaddrs.h src/IPPacketPayload.h src/TCPHeaderData.h src/TCPConnection.h src/TCPState.h src/tcpConnwaitEventCallback.h src/tcpConnwaitPacketsProcessor.h
...
bin/enqueuePacket.o: src/enqueuePacket.c src/enqueuePacket.h src/contrib/heap.h src/CaptureContext.h src/PacketQueueItem.h
...
bin/tcpEstablishedEventCallback.o: src/tcpEstablishedEventCallback.c src/tcpEstablishedEventCallback.h src/SrcDstSockaddrs.h src/TCPSiteQueueItem.h src/TCPConnection.h src/dequeueSiteQueueItem.h src/tcpUpdateEvent.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/tcpEstablishedEventCallback.o src/tcpEstablishedEventCallback.c
bin/tcpEstablishedPacketsProcessor.o: src/tcpEstablishedPacketsProcessor.c src/tcpEstablishedPacketsProcessor.h src/contrib/avl.h src/contrib/heap.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/TCPConnection.h src/TCPHeaderData.h src/TCPSitePrequeueItem.h src/CaptureContext.h src/getMonotonicTimeval.h src/addTimeval.h src/checkByteInWindow.h src/enqueueTimeout.h src/tcpDeleteExpiredSegment.h src/enqueueSiteDataFromPrequeueItem.h src/tcpUpdateEvent.h src/cancelTimeout.h src/startTimer.h src/sendTCPAcknowledgement.h src/segexpire_delay.h src/MAX_SITE_QUEUE.h
