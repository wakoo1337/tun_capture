...
bin/processUDPPacket.o: src/processUDPPacket.c src/processUDPPacket.h src/contrib/logdel_heap.h src/CaptureContext.h src/TimeoutItem.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/UDPHeaderData.h src/UDPStackItem.h src/ChecksumContext.h src/UDPBinding.h src/get16Bit.h src/set16Bit.h src/initChecksum.h src/computeChecksum.h src/getChecksum.h src/findUDPBinding.h src/getMonotonicTimeval.h src/addTimeval.h src/udp_timeout.h
...
bin/findUDPBinding.o: src/findUDPBinding.c src/findUDPBinding.h src/contrib/avl.h src/CaptureSettings.h src/CaptureContext.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/UDPBinding.h src/udpReadCallback.h src/udpWriteCallback.h src/udpFinalizeRead.h src/udpFinalizeWrite.h src/getMonotonicTimeval.h src/addTimeval.h src/enqueueTimeout.h src/udpTimeoutCallback.h src/udp_timeout.h
...
bin/udpGenerator.o: src/udpGenerator.c src/udpGenerator.h src/contrib/logdel_heap.h src/ForwardingMappingIPv4.h src/ForwardingMappingIPv6.h src/CaptureSettings.h src/CaptureContext.h src/TimeoutItem.h src/UDPParameters.h src/UDPBinding.h src/ChecksumContext.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/PacketQueueItem.h src/initChecksum.h src/computeChecksum.h src/getChecksum.h src/set16Bit.h src/enqueueTxPacket.h src/sendPacketOnce.h src/addressFamilyToNetworkStrategy.h src/getMonotonicTimeval.h src/addTimeval.h src/udp_timeout.h src/HEADERS_RESERVE.h
...
bin/destroyTCPConnection.o: src/destroyTCPConnection.c src/destroyTCPConnection.h src/contrib/avl.h src/SrcDstSockaddrs.h src/CaptureSettings.h src/CaptureContext.h src/TCPConnection.h src/TCPAppQueueItem.h src/TCPSiteQueueItem.h src/PacketQueueItem.h src/cancelTimeout.h src/freeNoRefsAppQueueItem.h src/decrementAppQueueItemRefCount.h src/sendTCPPacketRefcounted.h src/processTCPData.h src/tcpDestroySitePrequeue.h src/tcpDestroyAppPrequeue.h src/processTCPUrgentData.h
...
bin/sendTCPAcknowledgement.o: src/sendTCPAcknowledgement.c src/sendTCPAcknowledgement.h src/CaptureSettings.h src/CaptureContext.h src/TCPHeaderData.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/SrcDstSockaddrs.h src/TCPConnection.h src/PacketQueueItem.h src/writeTCPHeader.h src/getSendWindowSize.h src/computeTCPDataOffset.h src/sendPacketOnce.h src/enqueueTxPacket.h src/HEADERS_RESERVE.h
	$(CC) $(CFLAGS) -c -o bin/sendTCPAcknowledgement.o src/sendTCPAcknowledgement.c
bin/processTCPUrgentData.o: src/processTCPUrgentData.c src/processTCPUrgentData.h src/SrcDstSockaddrs.h src/CaptureContext.h src/TCPConnection.h src/tcpDataProcessor.h
	$(CC) $(CFLAGS) -c -o bin/processTCPUrgentData.o src/processTCPUrgentData.c
bin/processTCPData.o: src/processTCPData.c src/processTCPData.h src/SrcDstSockaddrs.h src/CaptureContext.h src/TCPConnection.h src/tcpDataProcessor.h src/sendTCPFinalize.h
...
bin/readAndEnqueueSiteData.o: src/readAndEnqueueSiteData.c src/readAndEnqueueSiteData.h src/SrcDstSockaddrs.h src/TCPConnection.h src/PacketQueueItem.h src/enqueueRxPacket.h src/tcpUpdateReadEvent.h src/processTCPData.h src/processTCPUrgentData.h src/HEADERS_RESERVE.h src/MAX_APP_QUEUE.h
...
bin/enqueueUnsentTCPPacketsTransmission.o: src/enqueueUnsentTCPPacketsTransmission.c src/enqueueUnsentTCPPacketsTransmission.h src/contrib/avl.h src/SrcDstSockaddrs.h src/TCPAppQueueItem.h src/TCPConnection.h src/isAppQueueItemInWindow.h src/enqueueTCPPacketTransmission.h src/enqueueTCPRetransmission.h src/incrementAppQueueItemRefCount.h src/decrementAppQueueItemRefCount.h src/freeNoRefsAppQueueItem.h
...
bin/addPacketToPrequeue.o: src/addPacketToPrequeue.c src/addPacketToPrequeue.h src/contrib/avl.h src/CaptureContext.h src/SrcDstSockaddrs.h src/TCPConnection.h src/IPPacketPayload.h src/TCPHeaderData.h src/TCPSitePrequeueItem.h src/getMonotonicTimeval.h src/addTimeval.h src/enqueueTimeout.h src/cancelTimeout.h src/startTimer.h src/tcpDeleteExpiredSegment.h src/fillPrequeueItem.h src/segexpire_delay.h
...
bin/tcpLastSendPacketsProcessor.o: src/tcpLastSendPacketsProcessor.c src/tcpLastSendPacketsProcessor.h src/SrcDstSockaddrs.h src/TCPConnection.h src/IPPacketPayload.h src/TCPHeaderData.h src/isNewAckAcceptable.h src/scaleRemoteWindow.h src/tcpCleanupConfirmed.h src/enqueueUnsentTCPPacketsTransmission.h src/sendTCPAcknowledgement.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/tcpLastSendPacketsProcessor.o src/tcpLastSendPacketsProcessor.c
bin/compareTCPAppPrequeueItems.o: src/compareTCPAppPrequeueItems.c src/compareTCPAppPrequeueItems.h
	$(CC) $(CFLAGS) -c -o bin/compareTCPAppPrequeueItems.o src/compareTCPAppPrequeueItems.c
bin/tcpDestroySitePrequeue.o: src/tcpDestroySitePrequeue.c src/tcpDestroySitePrequeue.h src/contrib/avl.h src/SrcDstSockaddrs.h src/CaptureContext.h src/TCPConnection.h src/tcpDestroySitePrequeueItem.h
	$(CC) $(CFLAGS) -c -o bin/tcpDestroySitePrequeue.o src/tcpDestroySitePrequeue.c
bin/tcpDestroyAppPrequeueItem.o: src/tcpDestroyAppPrequeueItem.c src/tcpDestroyAppPrequeueItem.h src/SrcDstSockaddrs.h src/CaptureContext.h src/TCPConnection.h src/TCPAppQueueItem.h src/decrementAppQueueItemRefCount.h src/cancelTimeoutUnlocked.h
	$(CC) $(CFLAGS) -c -o bin/tcpDestroyAppPrequeueItem.o src/tcpDestroyAppPrequeueItem.c
bin/tcpDestroyAppPrequeue.o: src/tcpDestroyAppPrequeue.c src/tcpDestroyAppPrequeue.h src/contrib/avl.h src/SrcDstSockaddrs.h src/CaptureContext.h src/TCPConnection.h src/tcpDestroyAppPrequeueItem.h
	$(CC) $(CFLAGS) -c -o bin/tcpDestroyAppPrequeue.o src/tcpDestroyAppPrequeue.c
bin/fillPrequeueItem.o: src/fillPrequeueItem.c src/fillPrequeueItem.h src/SrcDstSockaddrs.h src/TCPConnection.h src/TCPSitePrequeueItem.h src/IPPacketPayload.h src/TCPHeaderData.h
	$(CC) $(CFLAGS) -c -o bin/fillPrequeueItem.o src/fillPrequeueItem.c
bin/processTCPPacketImmediately.o: src/processTCPPacketImmediately.c src/processTCPPacketImmediately.h src/SrcDstSockaddrs.h src/TCPConnection.h src/IPPacketPayload.h src/TCPSitePrequeueItem.h src/TCPHeaderData.h src/fillPrequeueItem.h src/prequeueItemToSiteData.h
	$(CC) $(CFLAGS) -c -o bin/processTCPPacketImmediately.o src/processTCPPacketImmediately.c
bin/sendTCPReset.o: src/sendTCPReset.c src/sendTCPReset.h src/CaptureSettings.h src/CaptureContext.h src/TCPHeaderData.h src/IPPacketPayload.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/SrcDstSockaddrs.h src/PacketQueueItem.h src/HEADERS_RESERVE.h src/computeTCPDataOffset.h src/writeTCPHeader.h src/enqueueTxPacket.h src/sendPacketOnce.h
	$(CC) $(CFLAGS) -c -o bin/sendTCPReset.o src/sendTCPReset.c
bin/udp_timeout.o: src/udp_timeout.c src/udp_timeout.h
	$(CC) $(CFLAGS) -c -o bin/udp_timeout.o src/udp_timeout.c
bin/udpFinalizeRead.o: src/udpFinalizeRead.c src/udpFinalizeRead.h src/UDPBinding.h src/udpReadFinalizer.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/udpFinalizeRead.o src/udpFinalizeRead.c
bin/udpFinalizeWrite.o: src/udpFinalizeWrite.c src/udpFinalizeWrite.h src/UDPBinding.h src/udpWriteFinalizer.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/udpFinalizeWrite.o src/udpFinalizeWrite.c
bin/udpDestroy.o: src/udpDestroy.c src/udpDestroy.h src/contrib/avl.h src/CaptureSettings.h src/CaptureContext.h src/PacketQueueItem.h src/UDPStackItem.h src/TimeoutItem.h src/UDPBinding.h src/udpGenerator.h
	$(CC) $(CFLAGS) -c -o bin/udpDestroy.o src/udpDestroy.c
bin/udpTimeoutCallback.o: src/udpTimeoutCallback.c src/udpTimeoutCallback.h src/contrib/logdel_heap.h src/CaptureContext.h src/UDPBinding.h src/TimeoutItem.h src/udpFinalizeRead.h src/udpFinalizeWrite.h
	$(CC) $(CFLAGS) -c -o bin/udpTimeoutCallback.o src/udpTimeoutCallback.c
bin/udpReadFinalizer.o: src/udpReadFinalizer.c src/udpReadFinalizer.h src/UDPBinding.h src/udpDestroy.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/udpReadFinalizer.o src/udpReadFinalizer.c
bin/udpWriteFinalizer.o: src/udpWriteFinalizer.c src/udpWriteFinalizer.h src/UDPBinding.h src/udpDestroy.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/udpWriteFinalizer.o src/udpWriteFinalizer.c
bin/tcpDataProcessor.o: src/tcpDataProcessor.c src/tcpDataProcessor.h src/contrib/avl.h src/CaptureSettings.h src/CaptureContext.h src/SrcDstSockaddrs.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/TCPConnection.h src/TCPAppQueueItem.h src/TCPHeaderData.h src/getSendWindowSize.h src/computeTCPDataOffset.h src/writeTCPHeader.h src/enqueueTCPPacketTransmission.h src/enqueueTCPRetransmission.h src/isAppQueueItemInWindow.h src/freeNoRefsAppQueueItem.h src/incrementAppQueueItemRefCount.h src/decrementAppQueueItemRefCount.h src/enqueueUnsentTCPPacketsTransmission.h src/HEADERS_RESERVE.h
	$(CC) $(CFLAGS) -c -o bin/tcpDataProcessor.o src/tcpDataProcessor.c
