...
bin/processTCPPacket.o: src/processTCPPacket.c src/processTCPPacket.h src/contrib/avl.h src/contrib/heap.h src/CaptureContext.h src/IPPacketPayload.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/SrcDstSockaddrs.h src/TCPHeaderData.h src/TCPConnection.h src/TCPState.h src/parseTCPHeader.h src/tcpCallback.h src/tcpstate_connwait.h
...
bin/tcpSynackSendPacketsProcessor.o: src/tcpSynackSendPacketsProcessor.c src/tcpSynackSendPacketsProcessor.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/TCPConnection.h src/TCPHeaderData.h src/tcpstate_established.h
...
bin/tcpstate_established.o: src/tcpstate_established.c src/tcpstate_established.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/TCPHeaderData.h src/TCPConnection.h src/TCPState.h src/tcpEstablishedEventCallback.h src/tcpEstablishedPacketsProcessor.h
	$(CC) $(CFLAGS) -c -o bin/tcpstate_established.o src/tcpstate_established.c
bin/tcpEstablishedEventCallback.o: src/tcpEstablishedEventCallback.c src/tcpEstablishedEventCallback.h src/SrcDstSockaddrs.h src/TCPConnection.h
	$(CC) $(CFLAGS) -c -o bin/tcpEstablishedEventCallback.o src/tcpEstablishedEventCallback.c
bin/tcpEstablishedPacketsProcessor.o: src/tcpEstablishedPacketsProcessor.c src/tcpEstablishedPacketsProcessor.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/TCPConnection.h src/TCPHeaderData.h
