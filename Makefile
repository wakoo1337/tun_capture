...
bin/tcpEstablishedPacketsProcessor.o: src/tcpEstablishedPacketsProcessor.c src/tcpEstablishedPacketsProcessor.h src/contrib/avl.h src/contrib/heap.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/TCPConnection.h src/TCPHeaderData.h src/TCPSitePrequeueItem.h src/CaptureContext.h src/getMonotonicTimeval.h src/addTimeval.h src/checkByteInWindow.h src/enqueueTimeout.h src/tcpDeleteExpiredSegment.h src/enqueueSiteDataFromPrequeueItem.h src/tcpUpdateReadEvent.h src/tcpUpdateWriteEvent.h src/cancelTimeout.h src/startTimer.h src/sendTCPAcknowledgement.h src/tcpCleanupConfirmed.h src/isNewAckAcceptable.h src/scaleRemoteWindow.h src/segexpire_delay.h src/tcpstate_gotfin.h src/MAX_SITE_QUEUE.h
...
bin/tcpGotFINOnEnd.o: src/tcpGotFINOnEnd.c src/tcpGotFINOnEnd.h src/SrcDstSockaddrs.h src/TCPConnection.h src/sendTCPFinalize.h
	$(CC) $(CFLAGS) -c -o bin/tcpGotFINOnEnd.o src/tcpGotFINOnEnd.c
