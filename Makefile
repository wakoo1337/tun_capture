...
bin/tcpEstablishedEventCallback.o: src/tcpEstablishedEventCallback.c src/tcpEstablishedEventCallback.h src/SrcDstSockaddrs.h src/TCPConnection.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/tcpEstablishedEventCallback.o src/tcpEstablishedEventCallback.c
bin/tcpEstablishedPacketsProcessor.o: src/tcpEstablishedPacketsProcessor.c src/tcpEstablishedPacketsProcessor.h src/contrib/avl.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/TCPConnection.h src/TCPHeaderData.h src/TCPSitePrequeueItem.h src/getMonotonicTimeval.h	src/addTimeval.h src/checkByteInWindow.h src/enqueueTimeout.h src/tcpDeleteExpiredSegment.h src/segexpire_delay.h src/MAX_SITE_QUEUE.h
