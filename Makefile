...
bin/timerCallback.o: src/timerCallback.c src/timerCallback.h src/contrib/C-Collections/pqlib/PQ.h src/TimeoutItem.h src/CaptureContext.h src/getMonotonicTimeval.h src/compareTimeval.h src/startTimer.h
...
bin/startTimer.o: src/startTimer.c src/startTimer.h src/contrib/C-Collections/pqlib/PQ.h src/TimeoutItem.h src/CaptureContext.h src/getMonotonicTimeval.h src/subTimeval.h
...
bin/processTCPPacket.o: src/processTCPPacket.c src/processTCPPacket.h src/contrib/C-Collections/pqlib/PQ.h src/contrib/avl.h src/CaptureContext.h src/IPPacketPayload.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/SrcDstSockaddrs.h src/TCPHeaderData.h src/TCPState.h src/TCPConnection.h src/parseTCPHeader.h src/tcpCallback.h src/tcpstate_connwait.h
...
bin/tcpConnwaitEventCallback.o: src/tcpConnwaitEventCallback.c src/tcpConnwaitEventCallback.h src/SrcDstSockaddrs.h src/TCPConnection.h src/destroyTCPConnection.h
	$(CC) $(CFLAGS) -c -o bin/tcpConnwaitEventCallback.o src/tcpConnwaitEventCallback.c
bin/destroyTCPConnection.o: src/destroyTCPConnection.c src/destroyTCPConnection.h src/contrib/C-Collections/pqlib/PQ.h src/contrib/avl.h src/SrcDstSockaddrs.h src/CaptureContext.h src/TCPConnection.h
