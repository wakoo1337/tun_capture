...
bin/tunReadCallback.o: src/tunReadCallback.c src/tunReadCallback.h src/contrib/heap.h src/CaptureSettings.h src/CaptureContext.h src/PacketQueueItem.h src/RefcountBuffer.h src/enqueueRxPacket.h src/packetsProcessor.h src/emergencyStop.h src/createRefcountBuffer.h src/decrementRefcount.h src/resizeRefcountBuffer.h
...
bin/threadWorker.o: src/threadWorker.c src/threadWorker.h src/contrib/heap.h src/CaptureContext.h src/RefcountBuffer.h src/PacketQueueItem.h src/dequeueRxPacket.h src/emergencyStop.h src/decrementRefcount.h
...
bin/processIPv4Packet.o: src/processIPv4Packet.c src/processIPv4Packet.h src/contrib/heap.h src/CaptureContext.h src/IPv4HeaderData.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/RefcountBuffer.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/parseIPv4Header.h src/processUDPPacket.h src/setIPv4SockaddrPort.h src/ipv4_strategy.h src/processTCPPacket.h src/decrementRefcount.h
...
bin/processUDPPacket.o: src/processUDPPacket.c src/processUDPPacket.h src/contrib/heap.h src/CaptureContext.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/UDPHeaderData.h src/RefcountBuffer.h src/UDPStackItem.h src/ChecksumContext.h src/UDPBinding.h src/get16Bit.h src/set16Bit.h src/initChecksum.h src/computeChecksum.h src/getChecksum.h src/findUDPBinding.h src/decrementRefcount.h
...
bin/packetsProcessor.o: src/packetsProcessor.c src/packetsProcessor.h src/contrib/heap.h src/CaptureContext.h src/RefcountBuffer.h src/processIPv4Packet.h src/decrementRefcount.h
	$(CC) $(CFLAGS) -c -o bin/packetsProcessor.o src/packetsProcessor.c
bin/udpGenerator.o: src/udpGenerator.c src/udpGenerator.h src/contrib/heap.h src/ForwardingMappingIPv4.h src/ForwardingMappingIPv6.h src/CaptureSettings.h src/CaptureContext.h src/UDPParameters.h src/UDPBinding.h src/ChecksumContext.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/RefcountBuffer.h src/PacketQueueItem.h src/initChecksum.h src/computeChecksum.h src/getChecksum.h src/set16Bit.h src/enqueueTxPacket.h src/decrementRefcount.h src/HEADERS_RESERVE.h src/ipv4_strategy.h src/ipv6_strategy.h
...
bin/processTCPPacket.o: src/processTCPPacket.c src/processTCPPacket.h src/contrib/avl.h src/contrib/heap.h src/CaptureContext.h src/RefcountBuffer.h src/IPPacketPayload.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/SrcDstSockaddrs.h src/TCPHeaderData.h src/TCPConnection.h src/TCPState.h src/parseTCPHeader.h src/compareTCPSitePrequeueItems.h src/tcpReadCallback.h src/tcpWriteCallback.h src/tcpDestroySitePrequeueItem.h src/tcpFinalizeRead.h src/tcpFinalizeWrite.h src/decrementRefcount.h src/tcpstate_connwait.h
...
bin/tcpConnwaitPacketsProcessor.o: src/tcpConnwaitPacketsProcessor.c src/tcpConnwaitPacketsProcessor.h src/RefcountBuffer.h src/IPPacketPayload.h src/TCPHeaderData.h src/SrcDstSockaddrs.h src/TCPConnection.h src/decrementRefcount.h
...
bin/tcpSynackSendPacketsProcessor.o: src/tcpSynackSendPacketsProcessor.c src/tcpSynackSendPacketsProcessor.h src/RefcountBuffer.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/TCPConnection.h src/TCPHeaderData.h src/TimeoutItem.h src/tcpCleanupConfirmed.h src/tcpUpdateEvent.h src/decrementRefcount.h src/tcpstate_established.h
...
bin/sendTCPPacket.o: src/sendTCPPacket.c src/sendTCPPacket.h src/contrib/heap.h src/CaptureSettings.h src/CaptureContext.h src/PacketQueueItem.h src/TCPAppQueueItem.h src/SrcDstSockaddrs.h src/TCPConnection.h src/enqueueTxPacket.h
...
bin/tcpEstablishedReadCallback.o: src/tcpEstablishedReadCallback.c src/tcpEstablishedReadCallback.h src/contrib/heap.h src/CaptureContext.h src/SrcDstSockaddrs.h src/TCPSiteQueueItem.h src/TCPConnection.h src/PacketQueueItem.h src/dequeueSiteQueueItem.h src/tcpUpdateEventUnlocked.h src/processTCPUrgentData.h src/processTCPData.h src/enqueueRxPacket.h src/HEADERS_RESERVE.h src/MAX_APP_QUEUE.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/tcpEstablishedReadCallback.o src/tcpEstablishedReadCallback.c
bin/tcpEstablishedWriteCallback.o: src/tcpEstablishedWriteCallback.c src/tcpEstablishedWriteCallback.h src/contrib/heap.h src/CaptureContext.h src/SrcDstSockaddrs.h src/TCPSiteQueueItem.h src/TCPConnection.h src/dequeueSiteQueueItem.h src/getSendWindowSize.h src/sendTCPAcknowledgement.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/tcpEstablishedWriteCallback.o src/tcpEstablishedWriteCallback.c
bin/tcpEstablishedPacketsProcessor.o: src/tcpEstablishedPacketsProcessor.c src/tcpEstablishedPacketsProcessor.h src/contrib/avl.h src/contrib/heap.h src/IPPacketPayload.h src/SrcDstSockaddrs.h src/TCPConnection.h src/TCPHeaderData.h src/TCPSitePrequeueItem.h src/CaptureContext.h src/getMonotonicTimeval.h src/addTimeval.h src/checkByteInWindow.h src/enqueueTimeout.h src/tcpDeleteExpiredSegment.h src/enqueueSiteDataFromPrequeueItem.h src/tcpUpdateEvent.h src/cancelTimeout.h src/startTimer.h src/sendTCPAcknowledgement.h src/tcpCleanupConfirmed.h src/segexpire_delay.h src/tcpstate_gotfin.h src/MAX_SITE_QUEUE.h
...
bin/dequeueSiteQueueItem.o: src/dequeueSiteQueueItem.c src/dequeueSiteQueueItem.h src/SrcDstSockaddrs.h src/TCPSiteQueueItem.h src/TCPConnection.h
	$(CC) $(CFLAGS) -c -o bin/dequeueSiteQueueItem.o src/dequeueSiteQueueItem.c
bin/sendTCPAcknowledgement.o: src/sendTCPAcknowledgement.c src/sendTCPAcknowledgement.h src/contrib/heap.h src/CaptureSettings.h src/CaptureContext.h src/TCPHeaderData.h src/IPFragmentMetadata.h src/NetworkProtocolStrategy.h src/SrcDstSockaddrs.h src/TCPConnection.h src/TCPAppQueueItem.h src/writeTCPHeader.h src/sendTCPPacket.h src/getSendWindowSize.h src/computeTCPDataOffset.h src/HEADERS_RESERVE.h
...
bin/udpWriteCallback.o: src/udpWriteCallback.c src/udpWriteCallback.h src/contrib/heap.h src/CaptureContext.h src/UDPBinding.h src/RefcountBuffer.h src/UDPStackItem.h src/emergencyStop.h src/decrementRefcount.h
...
bin/tcpUpdateEventUnlocked.o: src/tcpUpdateEventUnlocked.c src/tcpUpdateEventUnlocked.h src/SrcDstSockaddrs.h src/TCPConnection.h src/MAX_APP_QUEUE.h
	$(CC) $(CFLAGS) $(LIBEVENT_CFLAGS) -c -o bin/tcpUpdateEventUnlocked.o src/tcpUpdateEventUnlocked.c
...
bin/createRefcountBuffer.o: src/createRefcountBuffer.c src/createRefcountBuffer.h src/RefcountBuffer.h
	$(CC) $(CFLAGS) -c -o bin/createRefcountBuffer.o src/createRefcountBuffer.c
bin/incrementRefcount.o: src/incrementRefcount.c src/incrementRefcount.h src/RefcountBuffer.h
	$(CC) $(CFLAGS) -c -o bin/incrementRefcount.o src/incrementRefcount.c
bin/decrementRefcount.o: src/decrementRefcount.c src/decrementRefcount.h src/RefcountBuffer.h
	$(CC) $(CFLAGS) -c -o bin/decrementRefcount.o src/decrementRefcount.c
bin/resizeRefcountBuffer.o: src/resizeRefcountBuffer.c src/resizeRefcountBuffer.h src/RefcountBuffer.h
	$(CC) $(CFLAGS) -c -o bin/resizeRefcountBuffer.o src/resizeRefcountBuffer.c
